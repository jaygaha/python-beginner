...
# Iterate through the nominated dictionary
...
# Output the nominations count dictionary
...
# Iterate through the winners dictionary
...
most_win_director = {}
# Add your code here
for directors in winners.values():
    for director in directors:
        if director in most_win_director:
            most_win_director[director] += 1
        else:
            most_win_director[director] = 1

# Step 2: Find the maximum number of wins
max_wins = max(most_win_director.values())

# Step 3: Create a list of directors with the maximum number of wins
most_win_director = [director for director, count in most_win_director.items() if count == max_wins]
