...
#
# Interface: It is a set of methods that define the behavior of an object. An interface is a contract that an object must adhere to.
# Abstract class: An abstract class is a class that cannot be instantiated. It is used to define an interface for a class.
# Abstract method: An abstract method is a method that is declared in an abstract class but does not have an implementation.
...
lin_eq = LinearEquation(7, 9)
quadr_eq = QuadraticEquation(6, 8, 1)
print(solver(lin_eq))
